...
from mxbi.tasks.GNGSiD.stages.size_reduction_stage.models import config
from mxbi.tasks.GNGSiD.tasks.detect_touch_to_reward.models import TrialConfig
from mxbi.tasks.GNGSiD.tasks.detect_touch_to_reward.scene import (
    GNGSiDDetectTouchToRewardScene,
)
...
class SizeReductionStage:
    ...
    def __init__(
        ...
        self._task = GNGSiDDetectTouchToRewardScene(
            theater,
            animal_state,
